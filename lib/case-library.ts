...
export const CASE_LIBRARY_BLOCK = [
  ...
  "案例3｜段永平2001-2002年买网易：背景=互联网泡沫破裂+财务风波，股价跌破每股净现金（<$1）；反方论据=可能退市、游戏业务未被验证、中概信任危机；判断依据=「这家公司账上现金比市值还多+我懂游戏（做小霸王出身）+丁磊的产品能力」；结果=约100倍。可迁移模式：极端错杀+能力圈常识的双重确认——不懂的便宜不碰，懂的错杀重仓（对接段永平风格的能力圈纪律）。",
].join("\n");
